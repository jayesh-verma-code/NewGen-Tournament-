...
function landing() {
  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-white transition hover:opacity-75"> Free Fire Tournament </a>
            </li>

            <li>
              <a href="#" className="text-white transition hover:opacity-75"> COD Tournament </a>
            </li>

            <li>
              <a href="#" className="text-white transition hover:opacity-75"> PUBG Tournament </a>
            </li>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" className="text-white transition hover:opacity-75"> History </a>
            </li>
          </ul>
        </div>
    ...
    <p className="text-xs text-white">&copy; 2025. NewGen Tournament. All rights reserved.</p>
  </div>
</footer>
    </div>
  )
